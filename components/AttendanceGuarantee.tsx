...
export default function AttendanceGuarantee() {
  return (
    <section
      ...
      className="relative pt-16 md:pt-20 pb-8 md:pb-10 bg-transparent overflow-hidden"
    >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 relative z-10">
            {steps.map((item) => (
              ...
              >
                ...
                {/* Step Title */}
                <h3 className="font-normal text-slate-900 mt-4 text-center text-base font-serif" style={{ fontFamily: "Georgia, serif" }}>
                  {item.title}
                </h3>
            ...
            {eventTypes.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Title */}
                  <h3 className="text-slate-900 font-normal text-lg mt-3 font-serif" style={{ fontFamily: "Georgia, serif" }}>
                    {item.title}
                  </h3>
