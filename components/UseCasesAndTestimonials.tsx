...
export default function UseCasesAndTestimonials() {
  return (
    <section
      id="testimonials"
      className="relative pt-10 md:pt-12 pb-20 md:pb-28 bg-transparent overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-normal text-slate-900 tracking-tight font-serif mt-2 md:mt-3" style={{ fontFamily: "Georgia, serif" }}>
