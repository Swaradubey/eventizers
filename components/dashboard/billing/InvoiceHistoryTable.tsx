...
export default function InvoiceHistoryTable({
  ...
  return (
    <div ref={tableContainerRef} className="space-y-6">
      <div>
        <h2 className="font-normal text-2xl text-slate-900 force-georgia">
          Invoice History
        </h2>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 id="delete-invoice-modal-title" className="text-base font-normal text-slate-900 force-georgia">
