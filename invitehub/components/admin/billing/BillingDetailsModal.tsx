      ...
      >
        ...
        <div className="flex justify-between items-start mb-6">
          <div>
            ...
            <h3
              className="text-2xl sm:text-3xl font-normal mt-1 break-words text-[#2D1B3D] force-georgia"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
          ...
          <div className="space-y-4">
            <div className="bg-gradient-to-br from-blue-50/70 via-sky-50/40 to-slate-50 border border-blue-100/80 rounded-2xl p-4 space-y-3 shadow-sm">
              <h4 className="text-xs font-normal text-blue-900/60 uppercase tracking-wider mb-2 force-georgia">
                User Details
              </h4>
          ...
          <div className="bg-gradient-to-br from-blue-50/70 via-sky-50/40 to-slate-50 border border-blue-100/80 rounded-2xl p-4 flex flex-col justify-between shadow-sm">
            <div>
              <h4 className="text-xs font-normal text-blue-900/60 uppercase tracking-wider mb-4 force-georgia">
                Usage Statistics
              </h4>
        ...
        <div className="space-y-3">
          <h4 className="text-xs font-normal text-blue-900/60 uppercase tracking-wider force-georgia">
            Billing History
          </h4>
      ...
      <AnimatePresence>
        {showConfirmDelete && (
          <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
            ...
            >
              <h3 className="text-lg font-normal mb-2 force-georgia" style={{ fontFamily: "Georgia, 'Times New Roman', Times, serif" }}>
                Delete User
              </h3>
