      ...
      <main className="flex-1 flex flex-col max-w-7xl w-full mx-auto px-8 pt-6 pb-12 z-10">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-normal text-slate-900 force-georgia font-['Georgia',serif]">Billing</h1>
        ...
        {loading ? (
          ...
          <div className="bg-white border border-slate-100 rounded-2xl p-16 text-center flex flex-col items-center justify-center shadow-sm">
            ...
            <h4 className="text-xl font-normal text-slate-900 force-georgia">
          ...
          <div>
            ...
            {/* ── 2. Choose your plan ── */}
            <div className="mb-10">
              <h2 className="text-lg font-normal text-slate-900 mb-4 force-georgia">Choose your plan</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-10">
              ...
              <div className="lg:col-span-1">
                <h2 className="font-normal text-2xl text-slate-900 mb-0.5 force-georgia">Payment Method</h2>
