  ...
  const handlePreferencesSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.success) {
        ...
        // Immediately apply the new theme to the whole dashboard
      ...
      <main className="flex-1 flex flex-col max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-16 z-10">
        ...
        <div className="mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-4xl md:text-5xl font-semibold text-[#2D1B3D] font-display" style={{ fontFamily: "'Playfair Display', serif" }}>
                Settings
              </h1>
              <p className="text-sm text-[#2D1B3D]/60 mt-1">
                Configure your personal preferences, security, profile and team members.
              </p>
            </div>
          </div>
        </div>
              ...
              {TABS.map((tab) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-3 px-4 py-3 text-xs font-semibold rounded-xl transition-all relative text-left ${
                      isActive
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="divide-y divide-[#E8C4B8]/20 flex flex-col">
                    {[
                      ...
                      return (
                        <div key={item.key} className="py-4 flex justify-between items-center gap-4">
              ...
              {activeTab === "security" && (
                <div className="flex flex-col gap-8">
                  ...
                  <div className="flex flex-col gap-6">
                    ...
                    <div className="divide-y divide-[#E8C4B8]/20 flex flex-col">
                      {[
                        { key: "twoFactorAuth", title: "Two-factor Authentication (2FA)", desc: "Enforce verification code check on logins." },
                        { key: "publicProfile", title: "Public Directory Profile", desc: "Let external visitors discover your page profile." },
