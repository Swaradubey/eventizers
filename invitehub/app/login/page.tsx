...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-[100dvh] bg-[#FAF8F5] flex flex-col justify-center py-4 sm:py-6 pb-6 sm:pb-8 px-4 sm:px-6 lg:px-8 overflow-y-auto">
      <div className="w-full max-w-md mx-auto my-auto">
        ...
        <div className="text-center">
          ...
          <p className="mt-1 text-xs sm:text-sm text-[#2D1B3D]/60 font-body">
        ...
        <div className="mt-3 sm:mt-4">
          <div className="bg-white p-5 sm:p-6 sm:px-8 shadow-xl rounded-2xl border border-[#E8C4B8]/30">
            <form className="space-y-3 sm:space-y-3.5" onSubmit={handleSubmit}>
              ...
              <div>
                <label
                  htmlFor="email"
                  className="block text-xs font-semibold uppercase tracking-wider text-[#2D1B3D]/70 mb-1.5 font-body"
                >
                  Email Address
                </label>
                <div className="relative rounded-md shadow-sm">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-3 py-2 sm:py-2.5 bg-[#FAF8F5] border border-[#E8C4B8]/40 rounded-xl text-[#2D1B3D] placeholder-[#2D1B3D]/30 focus:outline-none focus:ring-2 focus:ring-[#C9A84C]/50 focus:border-[#C9A84C] text-sm transition-all"
              ...
              <div>
                ...
                <div className="relative rounded-md shadow-sm">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-10 py-2 sm:py-2.5 bg-[#FAF8F5] border border-[#E8C4B8]/40 rounded-xl text-[#2D1B3D] placeholder-[#2D1B3D]/30 focus:outline-none focus:ring-2 focus:ring-[#C9A84C]/50 focus:border-[#C9A84C] text-sm transition-all"
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
              ...
              <div className="my-1 sm:my-1.5 flex items-start gap-2">
                ...
                <label
                  ...
                  className="text-xs text-gray-500 cursor-pointer select-none leading-snug sm:leading-relaxed"
                >
              ...
              <div className="relative my-2.5 sm:my-3">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-white px-2 text-[#2D1B3D]/50 font-semibold tracking-wider font-body text-[11px] sm:text-xs">
                    OR CONTINUE WITH
                  </span>
                </div>
              </div>
              ...
              <div>
                <button
                  ...
                  className="w-full flex justify-center items-center gap-3 py-2.5 px-4 border border-[#E8C4B8]/40 rounded-xl bg-white hover:bg-[#FAF8F5] text-sm font-semibold text-[#2D1B3D] shadow-sm transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#C9A84C]/50"
                >
            ...
            <div className="mt-3.5 sm:mt-4 border-t border-[#E8C4B8]/20 pt-3.5 sm:pt-4 text-center">
