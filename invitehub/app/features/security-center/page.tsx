  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#FAF8F5] pt-32 pb-24 px-6 max-w-5xl mx-auto w-full flex flex-col items-center justify-center text-center">
        ...
        <h1 className="text-3xl md:text-4xl font-serif font-normal tracking-tight text-slate-900 mb-4" style={{ fontFamily: "Georgia, serif" }}>
          Security Center
        </h1>
        
        <p className="text-lg text-[#2D1B3D]/70 max-w-2xl mb-8 font-body leading-relaxed">
          Fraud & attendance protection. Block unauthorized access, prevent ticketing scams, and secure guest data using state of the art cryptography.
        </p>
