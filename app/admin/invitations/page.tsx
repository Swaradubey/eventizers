            ...
            >
              ...
              <div className="space-y-4 text-xs font-semibold text-[#2D1B3D]/70 uppercase tracking-wider">
                <div>
                  ...
                  <p className="text-sm font-bold text-[#2D1B3D] mt-0.5 normal-case">{viewingInvitation.title}</p>
                </div>
                {viewingInvitation.subtitle && (
                  <div>
                    <span className="text-[10px] text-[#2D1B3D]/40">Subtitle</span>
                    <p className="text-sm font-semibold text-[#2D1B3D] mt-0.5 normal-case">{viewingInvitation.subtitle}</p>
                  </div>
                )}
                {viewingInvitation.mainText && (
                  <div>
                    <span className="text-[10px] text-[#2D1B3D]/40">Custom Message</span>
                    <p className="text-xs font-medium text-[#2D1B3D] mt-0.5 normal-case whitespace-pre-line leading-relaxed bg-[#FAF8F5] p-3 rounded-xl border border-[#E8C4B8]/20">{viewingInvitation.mainText}</p>
                  </div>
                )}
                <div>
                  <span className="text-[10px] text-[#2D1B3D]/40">Event Title</span>
                  <p className="text-xs font-bold text-[#C9A84C] mt-0.5 normal-case">{viewingInvitation.eventTitle}</p>
                </div>
                <div>
