...
function AIAssistantContent() {
  ...
  const quickPrompts = [
    ...
    {
      label: "Tech startup product launch & networking mixer",
    ...
    {
      label: "Intimate candlelit anniversary dinner for close family",
      ...
      try {
        ...
        if (user) {
          try {
            ...
            console.warn("[AIAssistant] Immediate cloud pre-upload fallback:", uploadErr);
          }
        }
      } catch (e) {
    ...
    <div className="min-h-screen invitation-bg invitation-pattern flex flex-col font-sans text-slate-900 relative">
      ...
      <main className="ai-assistant-page flex-1 flex flex-col w-full mx-auto relative overflow-hidden overflow-x-clip py-8 px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col justify-center items-center overflow-x-clip">
          ...
          {/* Main Heading */}
          <h1
            className="font-normal font-serif tracking-tight text-3xl sm:text-4xl lg:text-5xl text-center leading-tight bg-gradient-to-r from-[#4C75F2] via-[#1D77F3] to-[#00A3FF] bg-clip-text text-transparent pb-1 md:whitespace-nowrap force-georgia"
          ...
          <div className="relative w-full mx-auto max-w-2xl lg:max-w-3xl z-10">
            ...
            <div className="bg-white rounded-3xl border border-gray-100 shadow-xl p-7 md:p-10 min-h-[400px] relative z-10 text-left">
              ...
              {errorMsg && (
                <div className="p-3 mb-4 text-xs font-medium bg-red-50/90 border border-red-200/80 text-red-700 rounded-xl transition-all flex items-center justify-between">
              ...
              {successMsg && (
                <div className="p-3 mb-4 text-xs font-medium bg-emerald-50/90 border border-emerald-200/80 text-emerald-700 rounded-xl transition-all flex items-center justify-between">
                  <div className="flex items-center gap-2">
                  ...
                  {aiEventData && (
                    <div className="mt-4 p-4 bg-[#F9FAFB] border border-gray-200 rounded-2xl text-left space-y-3 max-h-[450px] overflow-y-auto">
                      <div className="flex justify-between items-start border-b border-gray-200 pb-2.5">
                        <div>
                          <h3 className="text-sm font-normal text-gray-900 leading-tight font-serif" style={{ fontFamily: "Georgia, serif" }}>
                            {aiEventData.title}
                          </h3>
                        ...
                        <div className="bg-blue-50 px-2 py-0.5 rounded-lg border border-blue-100 text-[10px] font-bold text-blue-700">
                          Budget: {aiEventData.estimatedBudget || "$1,500 - $3,000"}
                        </div>
                      </div>
                    ...
                    <div className="flex items-center justify-between gap-2 mb-2.5">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] sm:text-[11px] font-semibold bg-[#F0EEFF] text-[#6C5CE7] border border-[#6C5CE7]/20">
                          {displayedTemplates.length} available
                        </span>
                      </div>
